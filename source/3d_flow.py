...
df = temp.query("x>=30.0 & x<=50.0 & y>=-1.0 & y<=5.0")
...
wavy = pd.read_csv(path + 'wavy.dat', skipinitialspace=True)
...
cover = walldist < 0.0  # np.where(walldist[:,:] < 0.0)
