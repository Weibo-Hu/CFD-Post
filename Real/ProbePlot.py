...
path3 = "/media/weibo/Data1/BFS_M1.7L_fine/DataPost/"
...
#time1 = Probe0.time
Probe10 = DataPost()
Probe10.LoadProbeData (-10.0, 0.0, 0.0, path1, Uniq = True)
#Probe10.unique_rows()
Probe10.ExtraSeries('time', t1, t2)
#Probe10.AveAtSameXYZ('All')
Probe20 = DataPost()
Probe20.LoadProbeData (10.0, -3.0, 0.0, path1, Uniq = True)
#Probe20.unique_rows()
Probe20.ExtraSeries('time', t1, t2)
#Probe20.AveAtSameXYZ('All')
#time2 = Probe20.time
Probe30 = DataPost()
Probe30.LoadProbeData (20.0, -3.0, 0.0, path1, Uniq = True)
#Probe30.unique_rows()
