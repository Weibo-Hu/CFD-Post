...
%     on page 149. 
%
% This program benefitted from the following program
...
%                       a set of line segments defining a 2 or 3D line.
...
%                                                v=f(x,y,z)
%                       FElines.datapacking --- is it block or point
...
%                         triangle elements or quadrilateral elements defined
...
%
%                            geometryies.datapacking --point or block
...
%                                         default)
%
%                            geomoetries.datatype -- datatype (DT) of the 
...
%              defined on nodes. (Please email Wen Long at wen.long@PNNL.gov
%              for the psm_grid_v2.mat file to run Example 15 and 16.
%
